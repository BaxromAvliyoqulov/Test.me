    ...
    <div class="badges-container">
      ...
      <div class="smart-filter-container">
        <div class="search-box">
          ...
          <input type="text" v-model="searchQuery" :placeholder="isRus ? 'Поиск достижений...' : 'Yutuqlarni qidirish...'" />
        </div>
        <div class="filter-tabs">
          ...
          <button :class="{ active: activeFilter === 'unlocked' }" @click="activeFilter = 'unlocked'">
            <i class="fas fa-unlock"></i> {{ isRus ? 'Открыто' : 'Ochilgan' }}
          </button>
      ...
      <div class="badges-grid" v-if="filteredBadges.length > 0">
        <div
